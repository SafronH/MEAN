        ...
        !function() {
                            ...
                            var v = t.current.scheduleMacroTask("fetch", f, c, function() {
                                ...
                                if (l)
                                    if (h && h.abortController && !h.aborted && "function" == typeof h.abortController.abort && u)
                                        ...
                                        d("cancel fetch need a AbortController.signal");
                                else
                    ...
                    if (!e.hasOwnProperty(i) || !e[i]) {
                        ...
                        u || (u = Z[l] = v("ON_PROPERTY" + l)), a.set = function(t) {
                            ...
                            if (s) {
                                var o = s && s.call(this);
                                if (o)
                                    return a.set.call(this, o), "function" == typeof t[k] && t.removeAttribute(r), o
                            }
                            return null
                        }, n(e, r, a), e[i] = !0
                    }
            ...
            function U(e, t, n) {
                        ...
                        if (t = t || e.event) {
                            ...
                            if (r)
                                if (1 === r.length)
                                    ...
                                    for (var o = r.slice(), a = 0; a < o.length && (!t || !0 !== t[G]); a++)
                                        m(o[a], n, t)
                        }
                    },
                    _ = function(t) {
                ...
                function b(t, n) {
                    ...
                    var j = i ? function(e) {
                            if (!D.isExisting)
                                return C(e), Z.call(D.target, D.eventName, D.capture ? _ : k, D.options)
                        } : function(e) {
                        ...
                        I = i ? function(e) {
                            ...
                            if (e.allRemoved)
                                return z.call(e.target, e.eventName, e.capture ? _ : k, e.options)
                        } : function(e) {
                        ...
                        if (!s || s(z, a, n, arguments)) {
                            ...
                            if (l)
                                for (var p = 0; p < l.length; p++) {
                                    var h = l[p];
                                    if (M(h, a))
                                        return l.splice(p, 1), h.isRemoved = !0, 0 === l.length && (h.allRemoved = !0, n[i] = null), h.zone.cancelTask(h), b ? n : void 0
                                }
                            return z.apply(this, arguments)
                        }
                    }, T[c] = function() {
